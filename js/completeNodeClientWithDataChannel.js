...
function sendMessage(message){
    ...
    // must include both channel (room string) and message content in the message dic object
...
function createPeerConnection() {
    ...
    if (isInitiator) {
        ...
        console.log("remote peer try to get event.channel");
        pc.ondatachannel = gotReceiveChannel;
        console.log("remote peer try to get event.channel success");
    }
}
...
function gotReceiveChannel(event) {
    console.log("remote peer try to get event.channel ing...");
    trace('Receive Channel Callback');
    receiveChannel = event.channel;
    receiveChannel.onmessage = handleMessage;
    receiveChannel.onopen = handleReceiveChannelStateChange;
    receiveChannel.onclose = handleReceiveChannelStateChange;
    console.log("remote peer try to get event.channel finished");
}
...
function doAnswer() {
    ...
    pc.createAnswer(sdpConstraints).then(function(sessionDescription) {
        console.log("remote peer set initiator's session description");
        sendMessage(sessionDescription);
        return pc.setLocalDescription(sessionDescription);
    }).catch(onSignalingError);
    // Deprecated API
    // pc.createAnswer(setLocalAndSendMessage, onSignalingError, sdpConstraints);
    console.log('Sending answer to peer finished.');
}
...
function setLocalAndSendMessage(sessionDescription) {
    ...
    sendMessage(sessionDescription);
    console.log("remote peer preparing answer to be sent to initiator");
}
